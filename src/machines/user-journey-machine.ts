...
export const USER_JOURNEY_STATES = [
  {
    ...
    label: t`检查身份`,
    route: "/",
    description: t`读取本地匿名档案并决定是否需要首次身份引导。`,
  },
  {
    id: "onboarding.idle",
    label: t`首次身份引导`,
    route: "/identity",
    description: t`抽取并确认初始职业选手身份。`,
  },
  {
    id: "onboarding.rolling",
    label: t`初始身份抽取中`,
    route: "/identity",
    description: t`播放选手卡滚动动画并预载候选头像。`,
  },
  {
    id: "onboarding.result",
    label: t`初始身份待确认`,
    route: "/identity",
    description: t`展示抽取结果，确认后进入原本请求的页面。`,
  },
  {
    id: "lobby",
    label: t`模式大厅`,
    route: "/",
    description: t`查看身份、今日挑战和全部游戏模式入口。`,
  },
  {
    id: "identity.idle",
    label: t`身份管理`,
    route: "/identity",
    description: t`查看身份池、抽取次数并决定是否更换身份。`,
  },
  {
    id: "identity.rolling",
    label: t`身份重抽中`,
    route: "/identity",
    description: t`消耗抽取次数并播放滚动动画。`,
  },
  {
    id: "identity.result",
    label: t`新身份待选择`,
    route: "/identity",
    description: t`允许保留当前身份、使用新身份或再次抽取。`,
  },
  {
    id: "stats.list",
    label: t`战绩与回放`,
    route: "/stats",
    description: t`查看已持久化的对局结果和历史记录。`,
  },
  {
    id: "stats.replay",
    label: t`对局回放`,
    route: "/stats",
    description: t`在对话框中查看答案和逐次猜测结果。`,
  },
  {
    id: "daily.loading",
    label: t`今日挑战载入`,
    route: "/play/daily",
    description: t`从后端读取当天固定题目和已有进度。`,
  },
  {
    id: "daily.error",
    label: t`今日挑战载入失败`,
    route: "/play/daily",
    description: t`展示可恢复错误并允许重新载入。`,
  },
  {
    id: "daily.playing",
    label: t`今日挑战进行中`,
    route: "/play/daily",
    description: t`计时、搜索选手并在当前题库规定的机会内提交猜测。`,
  },
  {
    id: "daily.won",
    label: t`今日挑战成功`,
    route: "/play/daily",
    description: t`展示答案、结果明细和庆祝反馈。`,
  },
  {
    id: "daily.lost",
    label: t`今日挑战失败`,
    route: "/play/daily",
    description: t`机会耗尽或超时后展示答案和结果。`,
  },
  {
    id: "solo.selectingDifficulty",
    label: t`单人难度选择`,
    route: "/solo",
    description: t`选择简单、完整或困难题库。`,
  },
  {
    id: "solo.playing",
    label: t`单人练习进行中`,
    route: "/play/solo",
    description: t`随机题目计时竞猜。`,
  },
  {
    id: "solo.won",
    label: t`单人练习成功`,
    route: "/play/solo",
    description: t`展示结果并允许继续下一局。`,
  },
  {
    id: "solo.lost",
    label: t`单人练习失败`,
    route: "/play/solo",
    description: t`展示答案并允许重试或更换难度。`,
  },
  {
    id: "quick.setup",
    label: t`匹配设置`,
    route: "/quick",
    description: t`选择人数、题库、赛制和对手猜测可见性。`,
  },
  {
    id: "quick.submitting",
    label: t`匹配请求提交中`,
    route: "/quick",
    description: t`创建匹配票据并禁用重复提交。`,
  },
  {
    id: "quick.setupError",
    label: t`匹配请求失败`,
    route: "/quick",
    description: t`展示容量、网络或参数错误并允许重试。`,
  },
  {
    id: "quick.matching",
    label: t`等待匹配`,
    route: "/matching",
    description: t`显示排队与游戏中人数，并允许取消。`,
  },
  {
    id: "quick.canceling",
    label: t`取消匹配中`,
    route: "/matching",
    description: t`取消当前票据并防止重复操作。`,
  },
  {
    id: "quick.cancelError",
    label: t`取消匹配失败`,
    route: "/matching",
    description: t`保留排队状态、显示错误并允许再次取消。`,
  },
  {
    id: "quick.entering",
    label: t`匹配成功进场`,
    route: "/matching",
    description: t`播放匹配成功反馈后进入实时对局。`,
  },
  {
    id: "quick.waiting",
    label: t`匹配对局等待开局`,
    route: "/play/quick",
    description: t`等待所有玩家建立实时连接。`,
  },
  {
    id: "quick.playing",
    label: t`匹配回合进行中`,
    route: "/play/quick",
    description: t`同步双方或四人进度并提交猜测。`,
  },
  {
    id: "quick.roundResult",
    label: t`匹配单回合结算`,
    route: "/play/quick",
    description: t`展示当前回合答案并等待下一回合。`,
  },
  {
    id: "quick.seriesResult",
    label: t`匹配系列赛结算`,
    route: "/play/quick",
    description: t`展示最终胜负、比分和答案。`,
  },
  {
    id: "room.setup",
    label: t`好友房设置`,
    route: "/room",
    description: t`加入房间或配置人数、题库、赛制和可见性。`,
  },
  {
    id: "room.submitting",
    label: t`好友房提交中`,
    route: "/room",
    description: t`创建或加入房间请求正在处理。`,
  },
  {
    id: "room.error",
    label: t`好友房请求失败`,
    route: "/room",
    description: t`显示房间号、容量或网络错误并允许重试。`,
  },
  {
    id: "room.waiting",
    label: t`好友房等待开局`,
    route: "/play/room",
    description: t`等待房主和其他玩家就位。`,
  },
  {
    id: "room.playing",
    label: t`好友房回合进行中`,
    route: "/play/room",
    description: t`同步房间成员进度并进行同题竞猜。`,
  },
  {
    id: "room.roundResult",
    label: t`好友房单回合结算`,
    route: "/play/room",
    description: t`展示当前答案并等待房主开启下一局。`,
  },
  {
    id: "room.seriesResult",
    label: t`好友房系列赛结算`,
    route: "/play/room",
    description: t`展示系列赛最终排名和答案。`,
  },
] as const;
...
export const USER_CONNECTION_STATES = [
  {
    id: "idle",
    label: t`无需实时连接`,
    description: t`当前页面不依赖 Socket.IO。`,
  },
  {
    id: "connecting",
    label: t`建立实时连接`,
    description: t`正在握手并同步服务器快照。`,
  },
  {
    id: "connected",
    label: t`实时连接正常`,
    description: t`可接收广播并提交实时指令。`,
  },
  {
    id: "reconnecting",
    label: t`自动重连`,
    description: t`保留当前界面并尝试恢复实时连接。`,
  },
  {
    id: "offline",
    label: t`会话失效`,
    description: t`停止提交指令并提供显式恢复出口。`,
  },
  {
    id: "closed",
    label: t`主动离开`,
    description: t`用户主动退出后不再自动重连。`,
  },
] as const;
