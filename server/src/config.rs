...
pub struct Config {
    ...
    pub rematch_invite_timeout: Duration,
    pub rematch_start_transition: Duration,
    pub rematch_terminal_retention: Duration,
...
impl Config {
    pub fn from_env() -> Result<Self, AppError> {
        ...
        Ok(Self {
            ...
            round_transition: Duration::from_secs(parse_u64("CS_GUESS_ROUND_TRANSITION_SECS", 10)?),
            rematch_invite_timeout: Duration::from_secs(parse_nonzero_u64(
                "CS_GUESS_REMATCH_INVITE_SECS",
                20,
            )?),
            rematch_start_transition: Duration::from_millis(parse_nonzero_u64(
                "CS_GUESS_REMATCH_START_MS",
                750,
            )?),
            rematch_terminal_retention: Duration::from_secs(parse_nonzero_u64(
                "CS_GUESS_REMATCH_RESULT_SECS",
                5,
            )?),
    ...
    pub fn for_test() -> Self {
        Self {
            ...
            rematch_invite_timeout: Duration::from_millis(100),
            rematch_start_transition: Duration::from_millis(10),
            rematch_terminal_retention: Duration::from_millis(20),
